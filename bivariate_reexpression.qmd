...
# Refining Bivariate Models Through Re-expression
...
A demonstration of the workflow follows with a focus on the analysis rather than the code. The functions and code chunks required to generate these plots have been covered in previous chapters, including re-expression which was covered in [chapter 22](re_express.html).
