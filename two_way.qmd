...
$$
\begin{aligned}
\text{Deaths} &= 32.21 - 3.8\,\text{ed9to11} - 11.25\,\text{ed12} - 9.83\,\text{ed13to15} - 13\,\text{ed16} \\
              &\quad - 3.96\,\text{RegionNE} - 0.320\,\text{RegionS} - 2.980\,\text{RegionW} + \epsilon_{ij}
\end{aligned}
$$
...
$$
\begin{aligned}
\text{Deaths} &= 32.21 - 3.8(0) - 11.25(0) - 9.83(0) - 13(0) \\
              &\quad - 3.96(1) - 0.320(0) - 2.980(0) - 3.0 \\
              &= 32.21 - 3.96 - 3.0 \\
              &= 25.25 \approx 25.3
\end{aligned}
$$
