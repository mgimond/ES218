...
Note that the date object is formatted as *Year-Day-Month* in the output--this is R's default date format.
...
You'll note that since a day was not specified, the function defaulted to the first day of each month. If you prefer to center the date on each month, you can add a constant to the parsing function. For example, to center each month on the 15th day of that month, type:
