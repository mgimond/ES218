...
This should load five data frame objects into your R session: `dat1l`, `dat1l2`, `dat1w`, `dat2` and `dat2c`. The first three lines of each data frame are shown below:
