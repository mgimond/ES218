...
<p></p>
The spread of the fitted heights (across each voice part) is not insignificant compared to the spread of the combined residuals. **The spread in the fitted means encompasses about 90% of the spread in the residuals** (you can eyeball the percentage by matching the upper and lower mean values with the residuals' f-values).  The voice-parts *can* explain a good part of the variation in the data!
