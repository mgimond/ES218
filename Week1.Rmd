...
# Plot the data
d2 %>% ggvis(~Date, ~CO2) %>% layer_lines() %>% add_axis("x", title="Year") 
```
...
For example, a data table of grain production for the North America may consist of six variables and 1501 rows. The following table shows just the first 7 lines of the 1501 rows.
```{r echo=FALSE}
