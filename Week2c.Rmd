...
At this point, R treats the vector `x` as characters. To force R to interpret these as dates, use `lubridate`'s `mdy` function. `mdy` will convert date stings where the date elements are ordered as month, day and year (for other date element arrangements, see the table shown below).
