---
title: "Week2: Cleaning up dataframes"
output:
  html_document:
    toc: yes
    toc_depth: 3
...
# Get the data frame's dimensions
dim(dat)
```

`dat` consists of `r dim(dat)[1]` rows and `r dim(dat)[2]` columns. A brief description of each column follows:
...
Let's generate a summary of the table.
