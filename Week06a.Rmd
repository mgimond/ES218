...
As of version 3.0, `ggplot` has  the `stat_qq_line` function (or `geom_qq_line`) that will generate the interquartile fit. So to generate the theoretical QQ plot, use the `stat_qq` function (or `geom_qq`) to generate the point plot, then call `stat_qq_line` to generate the IQR fit.
