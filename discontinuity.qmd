...
To explore this further, we divide the data into three groups based on the apparent breakpoints: $x < 95$, $95 \leq x < 106$  and $x \geq 106$. We’ll label these groups 1, 2, and 3.
