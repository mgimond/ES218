...
You'll note that this last call not only returns the day of the week for each element (`r as.character(lubridate::wday(x.date, label = TRUE))`) but it also returns `levels` information along with its hierarchy.
