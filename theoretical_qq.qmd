...
Our actual normal q-q plot of the `alto` values does not look different from some of these simulated plots. This lends confidence in our earlier verdict that the `alto` height distribution can be characterized by a normal distribution.
