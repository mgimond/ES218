...
The *normal q-q plot* is just a special case of the *empirical q-q plot* we've covered in the previous chapter, the difference being that we assign the empirical quantiles to the y-axis and the matching normal quantiles to the x-axis. The x-axis units are standard deviations.
