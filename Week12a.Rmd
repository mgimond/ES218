...
```{r}
dat <- read.csv("https://github.com/mgimond/ES218/blob/gh-pages/Data/maine_commute.csv")
```
...
ggplot(shp2) + geom_sf(aes(fill = Commute), col = NA) + theme_minimal() +
scale_fill_steps2(low = "#1A9641", high = "#D73027", mid = "#FFFFBF",
                  midpoint = 25,
