...
Note that the `..density..` syntax is deprecated in the latest version of ggplot. Yet, you are likely to see its implementation in many online resources. Its replacement is the `after_stat()` function. For example, the following code will generate the same density histogram.
