...
a.df <- gridExtra::grid.table(data.frame(a), rows=NULL)
b.df <- gridExtra::grid.table(data.frame(b), rows=NULL)
gridExtra::grid.arrange(gridExtra:::rectGrob(), gridExtra::rectGrob(), nrow=1)
