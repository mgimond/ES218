...
Other methods can be passed to the function via the `q.type` argument. TO see the list of methods available to `eda_fval` type `$eda_fval`. For example, to compute the $f$ value as implemented in the `quantile` function, type:
