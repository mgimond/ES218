...
### The boxplot is a spatial case of a quantile function

The boxplot covered in the last section is a special case of $q(f)$ in that it only returns the 1^st^, 2^nd^ (median) and 3^rd^ quartiles. 
