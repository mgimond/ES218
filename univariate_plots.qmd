...
Continuing with our working example, we are seeking the quantile for $f$ = 0.5. The r code used to generate the interpolated quantile becomes:
...
This results in a quantile value of `r q_f`.
