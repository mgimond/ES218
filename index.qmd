...
While great effort is made to adopt a consistent plotting environment throughout this book (this being `ggplot2`, for the most part), a few topics (including the q-q plot and the median polish) will benefit from custom plotting functions available in the `tukeyedar` package. The [package](https://github.com/mgimond/tukeyedar/) can be downloaded from GitHub via the command:
