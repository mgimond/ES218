...
The test can be framed in several ways. Here, we are defining the null hypothesis as $\mu_{cont} \leq \mu_{ref}$  and the alternate hypothesis as $\mu_{cont} > \mu_{ref}$ where $\mu_{cont}$ is the mean concentration for the contaminated site and $\mu_{ref}$ is the mean concentration for the reference site. The test can be implemented in R as follows:
