...
::: {.output_example}```{r message=FALSE, warning=FALSE, echo=TRUE, fig.width=3, fig.height=2} 
plot(hp ~ mpg, mtcars)
```:::
...
::: {.output_example}```{r include=FALSE}
...
knitr::kable(head(mtcars[, 1:4]), format = "latex", booktabs = TRUE)
```
:::
:::
